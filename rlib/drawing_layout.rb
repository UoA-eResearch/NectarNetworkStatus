  ...
  @switch_pairs = [
    {
      ...
      :hosts => [
        ...
        { :type => '8', :name => 'sto07-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #15,16
        { :type => '8', :name => 'sto08-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #17,18
        { :type => '8', :name => 'sto13-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #19,20
        { :type => '8', :name => 'sto14-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #21,22
        nil,                              #23
        nil                               #24
      ]
    },
    {
      ...
      :hosts => [
        ...
        { :type => '4', :name => 'cop08-p', :ports => ['enp129s0f0','enp129s0f1','enp2s0f0','enp2s0f1'] }, #4
        ...
        { :type => '8', :name => 'sto09-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #9,10
        { :type => '8', :name => 'sto01-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #11,12
        { :type => '8', :name => 'sto02-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #13,14
        { :type => '8', :name => 'sto03-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #15,16
        { :type => '8', :name => 'sto04-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #17,18
        { :type => '8', :name => 'sto10-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #19,20
        { :type => '8', :name => 'sto11-p', :ports => ['eno1','eno2','enp131s0f0','enp131s0f1','enp132s0f0','enp132s0f1','T7','T8'] }, nil, #21,22
        nil,                              #22
        nil,                              #23
        nil                               #24
      ]
    ...
    },
    {
      ...
      :hosts => [
        ...
        { :type => '1r', :name => 'cop09-p', :ports => ['iDrac'] }, #8
        nil,                              #10
        nil,                              #11
