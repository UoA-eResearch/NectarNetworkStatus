    ...
    { 
      'cop01-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x6', 'port' => 'Te 1/2'}, 'Port-Channel' => 21, 'bond' => 0 },
      ...
      'cop02-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x6', 'port' => 'Te 1/4'}, 'Port-Channel' => 22, 'bond' => 0  },
      ...
      'cop03-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x6', 'port' => 'Te 1/6'}, 'Port-Channel' => 23, 'bond' => 0  },
      ...
      'cop04-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/2'}, 'Port-Channel' => 24, 'bond' => 0  },
      ...
      'cop05-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/4'}, 'Port-Channel' => 25, 'bond' => 0  },
      ...
      'cop06-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/6'}, 'Port-Channel' => 26, 'bond' => 0  },
      ...
      'cop07-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/8'}, 'Port-Channel' => 27, 'bond' => 0  },
      ...
      'cop09-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x6', 'port' => 'Te 1/10'}, 'Port-Channel' => 29, 'bond' => 0  },
      ...
      'cop10-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f0'  => { 'label' => 'T3', 'remote' => {'host' => 'x5', 'port' => 'Te 1/10'}, 'Port-Channel' => 29, 'bond' => 0  },
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/10'}, 'Port-Channel' => 29, 'bond' => 0  },
      ...
      'cop11-p' => { 
        ...
        'ports' => { 
          ...
          'enp3s0f0'  => { 'label' => 'T3', 'remote' => {'host' => 'x5', 'port' => 'Te 1/16'}, 'Port-Channel' => 31, 'bond' => 0  },
          'enp3s0f1'  => { 'label' => 'T3', 'remote' => {'host' => 'x7', 'port' => 'Te 1/16'}, 'Port-Channel' => 31, 'bond' => 0  },
