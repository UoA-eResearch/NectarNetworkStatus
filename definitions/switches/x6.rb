  ...
  def HOSTS::hosts
    { 'x6' => {
        ...
        'ports' => { 
          ...
          'Te 1/21' => {  'label' => '21', 'remote' => {'host' => 'sto01-p', 'port' => ''} },
          'Te 1/22' => {  'label' => '22', 'remote' => {'host' => 'sto02-p', 'port' => ''} },
          'Te 1/23' => {  'label' => '23', 'remote' => {'host' => 'sto03-p', 'port' => ''} },
          'Te 1/24' => {  'label' => '24', 'remote' => {'host' => 'sto04-p', 'port' => ''} },
