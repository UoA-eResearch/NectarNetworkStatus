  ...
  @switch_pairs = [
    ...
    },
    {
      ...
      :hosts => [
       ...
       { :type => '2l', :name => 'e18u42-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, # 9
       { :type => '2r', :name => 'e18u01-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #10
       { :type => '2l', :name => 'e18u41-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #11
       { :type => '2r', :name => 'e18u02-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #12
       { :type => '2l', :name => 'e18u40-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #13
       { :type => '2r', :name => 'e18u03-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #14
       { :type => '2l', :name => 'e18u39-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #15
       { :type => '2r', :name => 'e18u04-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #16
       { :type => '2l', :name => 'e18u38-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #17
       { :type => '2r', :name => 'e18u05-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #18
       { :type => '2l', :name => 'e18u37-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #19
       { :type => '2r', :name => 'e18u06-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #20
       { :type => '2l', :name => 'e18u36-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #21
       { :type => '2r', :name => 'e18u07-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #22
       { :type => '2l', :name => 'e18u35-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #23
       { :type => '2r', :name => 'e18u20-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #24
       { :type => '2l', :name => 'e18u23-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #25
       { :type => '2r', :name => 'e18u19-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #26
       { :type => '2l', :name => 'e18u24-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #27
       { :type => '2r', :name => 'e18u18-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #28
       { :type => '2l', :name => 'e18u25-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #29
       { :type => '2r', :name => 'e18u17-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #30
       { :type => '2l', :name => 'e18u26-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #31
       { :type => '2r', :name => 'e18u16-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #32
       { :type => '2l', :name => 'e18u27-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #33
       { :type => '2r', :name => 'e18u15-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #34
       { :type => '2l', :name => 'e18u28-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #35
       { :type => '2r', :name => 'e18u14-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #36
       { :type => '2l', :name => 'e18u29-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #37
       { :type => '2r', :name => 'e18u13-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #38
       { :type => '2l', :name => 'e18u30-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #39
       { :type => '2r', :name => 'e18u12-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #40
       { :type => '2l', :name => 'e18u31-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #41
       { :type => '2r', :name => 'e18u11-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #42
       { :type => '2l', :name => 'e18u32-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #43
       { :type => '2r', :name => 'e18u10-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #44
       { :type => '2l', :name => 'e18u33-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #45
       { :type => '2r', :name => 'e18u09-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #46
       { :type => '2l', :name => 'e18u34-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #47
       { :type => '2r', :name => 'e18u08-p', :ports => ['enp32s0f0','enp32s0f1d1'] }, #48        nil,                              #49
        nil,                              #50
        nil,                              #51
        nil,                              #52
        nil,                              #53
